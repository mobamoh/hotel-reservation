...
func (s MongoUserStore) InsertUser(ctx context.Context, user *types.User) (*types.User, error) {
	inserted, err := s.coll.InsertOne(ctx, user)
	if err != nil {
		return nil, err
	}
...
func (s MongoUserStore) UpdateUser(ctx context.Context, id string, data types.UserData) error {
	oid, err := primitive.ObjectIDFromHex(id)
	if err != nil {
		return err
	}
...
func (s MongoUserStore) DeleteUser(ctx context.Context, id string) error {
	...
	one, err := s.coll.DeleteOne(ctx, bson.M{"_id": oid})
